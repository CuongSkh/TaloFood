...
from app.schemas.product import (DeleteProductResponse, ImageUploadResponse, PaginatedProductResponse,
...
def list_products(search: str | None = None, category: str | None = None,
    ...
    return service.list_products(search=search, category=category, min_price=min_price, max_price=max_price,
